...
#SBATCH --output=/lustre/projects/Research_Project-MRC190311/scripts/integrative/blueprint/LogFiles/Optimal_States/temp.o #Put output file in log files with with temporary name
#SBATCH --error=/lustre/projects/Research_Project-MRC190311/scripts/integrative/blueprint/LogFiles/Optimal_States/temp.e #Put error file in log files with with temporary name
...
# Rename the output and error files to have format: [bin size]~[job id]~[date]-[time]
